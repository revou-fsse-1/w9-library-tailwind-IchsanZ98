function toggleMobileMenu() {
  const button = document.getElementById('m-menu-button')
  const menu = document.getElementById('m-menu')
  button.children[1].classList.contains('block')
    ? (button.children[1].classList.replace('block', 'hidden'),
      button.children[2].classList.replace('hidden', 'block'),
      menu.classList.replace('hidden', 'block'))
    : (button.children[1].classList.replace('hidden', 'block'),
      button.children[2].classList.replace('block', 'hidden'),
